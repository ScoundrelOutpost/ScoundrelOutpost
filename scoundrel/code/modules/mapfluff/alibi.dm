/obj/item/paper/fluff/alibipouch
	...
	\
	The camera can be used to collect visual evidence. Photos can be labeled with a pen and stored in the folder provided. <br><br> \
	\
	...
	can be printed for ease of distribution. More tapes can be printed at an autolathe. <br><br> \
	\
