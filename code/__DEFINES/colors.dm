...
// scoundrel content
#define COLOR_SPACE_AMBIENCE_MAIN "#AF654F"
#define COLOR_SPACE_AMBIENCE_DARK "#000000"
#define COLOR_SPACE_AMBIENCE_DEEP "#00137F"
#define COLOR_SPACE_AMBIENCE_ODD "#4E087F"
